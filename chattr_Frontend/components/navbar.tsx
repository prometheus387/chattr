		...
		>
			<div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between gap-4 px-6">
				...
				<div className="hidden items-center gap-2 sm:flex">
					{auth.isAuthorized ? (
						<span className="inline-flex h-9 items-center gap-2 rounded-lg border border-white/[0.06] bg-white/[0.02] px-3 text-[13px] text-white/75">
			...
			<div
				...
				className={clsx("mobile-menu sm:hidden", isMenuOpen && "mobile-menu-open")}
			>
